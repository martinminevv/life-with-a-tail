...
const translations = {
    bg: {
        ...
        'pets-li-1': 'Получи вярен и любящ приятел за цял живот',
        'pets-li-2': 'Подобри твоето психическо и физическо здраве',
        'pets-li-3': 'Кучетата помагат да намалиш стреса и тревожността',
        'pets-li-4': 'Участвай в спасяването на животни в нужда',
        'pets-li-5': 'Получи безусловна любов и вярност',
        'pets-li-6': 'Направи разликата в живота на домашните любимци',
        ...
        'testimonial-author-1': 'Иванов Иванов',
        ...
        'volunteer-subtitle': 'Направете разликата',
        'volunteer-why-title': 'Защо да доброволствате при нас?',
        'volunteer-why-desc': 'Доброволчество в "Живот с опашка" е награждаващо преживяване, което ви позволява да направите истинска разлика за животните. Независимо дали можете да отделите няколко часа седмично или само в уикендите, всеки момент, който дадете, ни помага да осигурим по-добра грижа на нашите животни.',
        ...
        'vol-cat-socializer-desc': 'Прекарайте време, играейки и социализирайки нашите котета, за да им помогнете да станат по-социални с хора.',
        
        // Adoption Page
        'adoption-title': 'Осинови домашен любимец',
        'adoption-subtitle': 'Дай на любящо животно вечен дом',
        'adoption-intro': 'Запознайте се с нашите прекрасни животни. Всяко животно заслужава дом и е готово да изпълни вашия живот с любов и радост.',
        ...
        'adoption-step-2-desc': 'Попълнете кандидатурата за осиновяване. След одобррение ще насрочим среща с избраният от вас домашен любимец.',
        ...
        'adoption-step-4-desc': 'След подписване на документите за осиновяване, можете да се приберете с вашия нов приятел до живот.',
        ...
        'adoption-faq-3-a': 'Да! Насърчаваме запознаване с вашите текущи домашни любимци, за да се опознаят.',
        'adoption-faq-4-q': 'Какво ако осиновяването не се получи?',
        'adoption-faq-4-a': 'Предлагаме 30-дневен период за връщане. Ако има проблеми, се свържете с нас, за да ги разрешим, или ще помогнем с намирането на нов дом на живното, ако е необходимо.',
        ...
        'vol-benefit-1-title': 'Направи истинска разлика',
        ...
        'vol-benefit-3-desc': 'Присъедини се към общност от любители на животни и направи трайни приятелства.',
        'vol-benefit-4-title': 'Гъвкав график',
        'vol-benefit-4-desc': 'Работим с твоите нужди, за да намерим доброволски смени, които отговарят на твоя начин на живот.',
        ...
        'vol-benefit-6-desc': 'Усети щастието и удоволетворението, които идват от помагане на животни в нужда.',
        ...
        'volunteer-req-1': 'Трябва да си на най-малко 16 години',
        'volunteer-req-2': 'Ангажирай се към минимум 3 месеца доброволчество',
        'volunteer-req-3': 'Посети задължителния инструктаж',
        ...
        'volunteer-req-6': 'Обичай животните',
        ...
        'contact-address': 'бул. Демокрация 18<br>Враца<br>България',
        ...
        'contact-emails': 'Основно: info@lifewithatail.com<br>Осиновяване: adopt@lifewithatail.com<br>Доброволчество: volunteer@lifewithatail.com',
        ...
        'contact-faq-1-a': 'Осиновяването може да се осъществи, както и онлайн, така и на място. Винаги може да дойдете в работно време и да разгледате нашите животни.',
        'contact-faq-2-q': 'Мога ли да донеса своя настоящ домашен любимец, за да срещне новия си приятел?',
        'contact-faq-2-a': 'Да! Насърчаваме срещи с твои настоящи домашни любимци. Моля, позвони предварително, за да организираме подходящо време за представяне.',
        ...
        'contact-faq-4-a': 'Абсолютно! Приемаме парични дарения, храна и играчки за домашни любимци и твоето време чрез доброволчество.',
